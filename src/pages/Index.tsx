      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-secondary/50 to-background">
        ...
        <div className="container relative py-20 sm:py-28 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mb-6 text-4xl font-bold tracking-tight text-primary sm:text-5xl lg:text-6xl animate-fade-in-up">
              VincentiansFile
            </h1>
            
            <p className="mb-10 text-lg text-muted-foreground sm:text-xl animate-fade-in-up">
      ...
      <section className="container py-16 sm:py-20">
        <div className="mb-10 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">Explore the latest contributions</p>
          </div>
          <Link to="/search">
      ...
      <section className="border-t border-border bg-gradient-to-b from-secondary/30 to-background">
        <div className="container py-16 sm:py-20">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="mb-4 text-2xl font-bold sm:text-3xl">Ready to Share Your Research?</h2>
            <p className="mb-8 text-muted-foreground">Join our community of researchers.</p>
            <Link to="/auth?mode=register">
              <Button variant="hero-accent" size="xl">
